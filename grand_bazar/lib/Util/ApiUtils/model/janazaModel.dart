...
//
//     final janazaModel = janazaModelFromJson(jsonString);

import 'dart:convert';

List<JanazaModel> janazaModelFromJson(String str) => List<JanazaModel>.from(json.decode(str).map((x) => JanazaModel.fromJson(x)));


//JanazaModel janazaModelFromJson(String str) => JanazaModel.fromJson(json.decode(str));
